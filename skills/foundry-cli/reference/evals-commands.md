...
# Example
pfoundry evals suite get ri.evals..evaluation-suite.00000000-0000-4000-8000-000000000002
```
...
# Example
pfoundry evals suite suggested-scope ri.evals..evaluation-suite.00000000-0000-4000-8000-000000000002 \
...
# Example
pfoundry evals run list ri.evals..evaluation-suite.00000000-0000-4000-8000-000000000002 --page-size 20
```
...
# Example
pfoundry evals run summary ri.evals..evaluation-suite.00000000-0000-4000-8000-000000000002 \
...
# Example
pfoundry evals run test-cases ri.evals..evaluation-suite.00000000-0000-4000-8000-000000000002 \
...
pfoundry evals run trigger ri.evals..evaluation-suite.00000000-0000-4000-8000-000000000002 \
    --definition run.json
