...
description: >-
  ...
  foundry, dependency, impact, downstream, upstream, ontology change, action, query,
  dataset, application, build, schedule, and RID.
---

# foundry-cli: Palantir Foundry CLI

This skill helps you use the foundry-cli to interact with Palantir Foundry effectively.

## Compatibility

- **Skill version**: 1.2.0
- **foundry-cli version**: 0.16.0+
- **Python**: 3.10+
- **Dependencies**: foundry-platform-sdk >=1.95.0,<2.0.0

## Overview

foundry-cli is a comprehensive CLI with 100+ commands for:
...
- **Agent contract**: Stable `foundry-agent-v1` envelopes with resumable pagination for native discovery and dataset statistics
