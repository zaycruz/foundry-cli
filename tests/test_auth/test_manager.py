...
class TestAuthManager:
    ...
    def test_init(self):
        """Test initialization."""
        with patch('pltr.auth.manager.CredentialStorage') as mock_storage_class, \
    ...
    def test_get_client_with_explicit_profile(self, mock_profile_class, mock_storage_class):
    ...
    @patch('pltr.auth.manager.CredentialStorage')
    @patch('pltr.auth.manager.ProfileManager')
    def test_get_client_with_default_profile(self, mock_profile_class, mock_storage_class):
    ...
    @patch('pltr.auth.manager.CredentialStorage')
    @patch('pltr.auth.manager.ProfileManager')
    def test_get_client_no_profile_configured(self, mock_profile_class, mock_storage_class):
        ...
        with pytest.raises(ProfileNotFoundError, match="No profile specified and no default profile configured"):
            manager.get_client()
    ...
    def test_get_client_profile_not_found(self, mock_profile_class, mock_storage_class):
        ...
        with pytest.raises(ProfileNotFoundError, match="Profile 'missing_profile' not found"):
    ...
    def test_create_provider_missing_auth_type(self):
        ...
        with pytest.raises(MissingCredentialsError, match="Authentication type not specified"):
    ...
    def test_create_provider_token_missing_token(self):
        ...
        with pytest.raises(MissingCredentialsError, match="Token not found in credentials"):
            manager._create_provider(credentials)
    ...
    def test_create_provider_oauth_missing_credentials(self):
        ...
        with pytest.raises(MissingCredentialsError, match="OAuth client credentials incomplete"):
            manager._create_provider(credentials)
    ...
    def test_create_provider_unknown_auth_type(self):
        ...
        with pytest.raises(MissingCredentialsError, match="Unknown authentication type: unknown_type"):
            manager._create_provider(credentials)
