...
from foundry_cli.commands import completion
from foundry_cli.utils.completion import (
    get_cached_rids,
    cache_rid,
    complete_rid,
    complete_profile,
...
class TestCompletionFunctions:
    ...
    def test_complete_rid(self):
        """Test RID completion."""
        with patch("foundry_cli.utils.completion.get_cached_rids") as mock_get:
    ...
    def test_complete_profile(self):
        ...
        with patch("foundry_cli.utils.completion.ProfileManager") as MockManager:
