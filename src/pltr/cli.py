...
from pltr.commands import configure, verify, dataset, ontology, sql, admin
...
app.add_typer(admin.app, name="admin", help="Admin operations for user, group, and organization management")
