"""
Main CLI entry point for foundry_cli.
"""
...
from foundry_cli import __version__
...
from foundry_cli.utils.tracing import command_paths_for_app, run_with_tracing
...
def main(
    ...
    Built on top of the official foundry-platform-sdk, foundry provides
