...
_IMPLEMENTED_EVIDENCE: dict[str, str] = {
    ...
    "run_ai_fde_agent_loop": (
        ...
        "tool execution (ontology_sql_query, evals tools, execute_action "
        "validate-then-apply, load_skill, state tools), tool-usage/"
        "assistant-message write-back via PUT /ai-fde/api/threads/{id}/"
        "update. Write tools are approval-gated; uncaptured tool contracts "
        "(documentation tools) fail closed"
    ),
