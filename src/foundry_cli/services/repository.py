...
client contract, see the foundry live
...
class RepositoryService(BaseService):
    ...
    # repository-bootstrapper call. Contract-verified end-to-end by foundry the
    ...
    CREATE_CONTRACT_EVIDENCE = (
        ...
        '"childTemplateIdsByPath": {"transforms-python": "python"}, '
        '"templateTokens": {}} -> 204. Contract-verified end-to-end by foundry '
    ...
    CREATE_CLEANUP_POLICY = (
        "created repositories are trashed with `foundry resource delete "
        "--force` and permanently removed with `foundry resource "
