...
class ConnectivityService(BaseService):
    ...
    def list_connections(self) -> List[Dict[str, Any]]:
        ...
        try:
            logger.warning(
                ...
                "Set FOUNDRY_CONNECTIONS_FALLBACK_START_FOLDER_RID to a narrower folder "
                "if this is slow."
            )
    ...
    def get_connection(self, connection_rid: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise RuntimeError(
                f"Failed to get connection {connection_rid}: {self._describe_error(e)}"
            )
    ...
    def create_connection(
        ...
        try:
            ...
            raise RuntimeError(
                f"Failed to create connection '{display_name}': {self._describe_error(e)}"
            )
    ...
    def get_file_import(self, connection_rid: str, import_rid: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise RuntimeError(
                f"Failed to get file import {import_rid}: {self._describe_error(e)}"
            )
    ...
    def execute_file_import(
        ...
        try:
            ...
            raise RuntimeError(
                f"Failed to execute file import {import_rid}: {self._describe_error(e)}"
            )
    ...
    def get_table_import(self, connection_rid: str, import_rid: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise RuntimeError(
                f"Failed to get table import {import_rid}: {self._describe_error(e)}"
            )
    ...
    def execute_table_import(
        ...
        try:
            ...
            raise RuntimeError(
                f"Failed to execute table import {import_rid}: {self._describe_error(e)}"
            )
    ...
    def list_file_imports(self, connection_rid: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise RuntimeError(
                f"Failed to list file imports: {self._describe_error(e)}"
            )
    ...
    def list_table_imports(self, connection_rid: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise RuntimeError(
                f"Failed to list table imports: {self._describe_error(e)}"
            )
    ...
    def get_webhook(
        ...
        try:
            ...
            raise RuntimeError(
                f"Failed to read webhook {webhook_rid}: {self._describe_error(e)}"
            ) from e
    ...
    def create_webhook(
        ...
        try:
            ...
            raise RuntimeError(
                f"Failed to create webhook '{name}': {self._describe_error(e)}"
            ) from e
    ...
    def update_webhook(self, webhook_rid: str, spec: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            raise RuntimeError(
                f"Failed to update webhook {webhook_rid}: {self._describe_error(e)}"
            ) from e
    ...
    def create_rest_source(
        ...
        try:
            ...
            raise RuntimeError(
                f"Failed to create REST source '{name}': {self._describe_error(e)}"
            ) from e
    ...
    def _list_egress_policy_rids(self, client: FoundryInternalClient) -> List[str]:
        ...
        try:
            ...
            raise RuntimeError(
                f"Failed to list network egress policies: {self._describe_error(e)}"
            ) from e
    ...
    def _get_egress_policies_batch(
        ...
        try:
            ...
            raise RuntimeError(
                f"Failed to read network egress policies: {self._describe_error(e)}"
            ) from e
    ...
    def _list_connections_from_filesystem(self) -> List[Dict[str, Any]]:
        ...
        Notes:
            ...
            - Traversal starts from FOUNDRY_CONNECTIONS_FALLBACK_START_FOLDER_RID when set,
